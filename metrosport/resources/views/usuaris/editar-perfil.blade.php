        ...
        <div class="row">
            ...
            @if ($equip)
                <div class="d-flex align-items-center mb-4">
                    <img src="{{ asset($equip->url_imagen) }}" alt="Escut de l'equip" class="rounded-circle me-3"
                        width="80" height="80">
                    <div>
                ...
                <div id="editForm" style="display: none;">
                    <form action="{{ route('perfil.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="button" class="btn" id="cancelEdit" style="color: #f44336;">Cancel·lar</button>
            ...
            {{-- SECCIÓN DE MAPAS --}}
            <div class="col-md-6">
                <p class="m-0">Ubicació de l'equip</p>
            ...
            <div class="col-md-6 pt-5">
                ...
                <form action="{{ route('dia_hora.store') }}" method="POST">
                    ...
                    <div class="table-responsive">
                                    ...
                                    <td>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                id="flexCheckLun00" name="checkbox_1"
                                                {{ in_array(1, $horasMarcadas) ? 'checked' : '' }}>
                                ...
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="6"
                                            id="flexCheckLun05" name="checkbox_6"
                                            {{ in_array(6, $horasMarcadas) ? 'checked' : '' }}>
                                ...
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="30"
                                            id="flexCheckMar05" name="checkbox_30"
                                            {{ in_array(30, $horasMarcadas) ? 'checked' : '' }}>
                                ...
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="54"
                                            id="flexCheckMie05" name="checkbox_54"
                                            {{ in_array(54, $horasMarcadas) ? 'checked' : '' }}>
                                ...
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="78"
                                            id="flexCheckJue05" name="checkbox_78"
                                            {{ in_array(78, $horasMarcadas) ? 'checked' : '' }}>
                                ...
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="102"
                                            id="flexCheckVie05" name="checkbox_102"
                                            {{ in_array(102, $horasMarcadas) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flexCheckVie05"></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="126"
                                            id="flexCheckSab05" name="checkbox_126"
                                            {{ in_array(126, $horasMarcadas) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flexCheckSab05"></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="150"
                                            id="flexCheckDom05" name="checkbox_150"
                                            {{ in_array(150, $horasMarcadas) ? 'checked' : '' }}>
                        ...
                        <button type="submit" class="btn btn-guardar">Guardar Horari</button>
                    </div>
                </form>
            </div>
        </div>
