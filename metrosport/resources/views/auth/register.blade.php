    ...
    <div class="card p-4 rounded-4" style="width: 350px;">
        ...
        <form method="POST" action="{{ route('register1') }}">
            ...
            <div class="mb-3">
                ...
                <input type="email" id="mail" name="mail" class="form-control rounded-4" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="contrasenya_confirmation" class="form-label">Confirmar Contrasenya</label>
                <input type="password" id="contrasenya_confirmation" name="contrasenya_confirmation" class="form-control rounded-4" required>
            </div>
            <div class="d-flex justify-content-center align-items-center">
                <button type="submit" class="btn p-2 w-50 btn-entrar rounded-4">Registrar-se</button>
            </div>
        </form>
        <div class="mt-3 text-center">
            <p class="mb-0"> Ja tens conta? <a href="{{ route('login') }}"> Inicia sessió</a></p>
        </div>
    </div>
